...
/// <summary>
/// Map surface contract — abstracts MapLibre/map.md or any other provider so the rest
...
public interface IMapProvider
{
    ...
    /// <summary>Draw (or update) a route polyline using the ORS coordinate list.</summary>
    ...
    /// <summary>Draw (or update) an isochrone polygon from the ORS exterior ring.</summary>
